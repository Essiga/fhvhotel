...
class CreateBookingComponent extends React.Component
{
    ...
    {
        return (
            <div className="p-16 bg-gray-50 h-full w-full bg-no-repeat bg-cover opacity-90" style={{backgroundImage: `url(${lobby})`}}>
                <h1 className="mt-40 mb-16 font-extrabold text-4xl text-blue-500 text-center">
