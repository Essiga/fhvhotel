...
(function(root, factory) {
  ...
  describe('BookingRestControllerApi', function() {
    ...
    describe('getRoomPrices', function() {
      it('should call getRoomPrices successfully', function(done) {
        //uncomment below and update the code to test getRoomPrices
        //instance.getRoomPrices(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
